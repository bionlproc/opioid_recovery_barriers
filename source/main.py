...
if __name__ == "__main__":
    ...
    new_barrier_embedding_file = classify_with_lit(
        barriers_lit_embedding_file, barrier_embedding_file, file_name, classification_threshold
    )
    ...
    # =============================================================================
    # Step 7: Generate Keyphrases and Filter Clusters with Keyphrase Classification
    # =============================================================================
    # Generate Keyphrases for the initial clusters and identify clusters that actually contain meaningful barriers using keyphrase classification.
    print("Step 7: Generating Keyphrases and Filtering clusters with keyphrase classification...")
